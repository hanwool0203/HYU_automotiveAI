...
def main():
    ...
    # pure pursuit와 맞출 차량 기준점
    car_center_x = 600
    car_y = 1000

    # 실제 기준 사각형을 BEV에서 표현할 픽셀 크기
    # 예: 실제 차선 폭 0.424m가 BEV에서 590px이 되게 함
    rect_width = 400

    # 예: 차량 앞 기준 구간 0.80m가 BEV에서 800px이 되게 함
    rect_height = 700

    # 기준 사각형을 차량 중심 기준으로 배치
    x_offset = int(car_center_x - rect_width / 2)
    y_offset = int(car_y - rect_height)
